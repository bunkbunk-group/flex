...
const IconLogo = props => {
  ...
  return (
    ...
    <svg
      ...
      // data-name="Layer 1"
      // xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 162.42 214.41"
    >
      {/* <title>FaviconMobiili</title> */}
      <path
        d="M229.72,27v76.27l7.9-6.25c37.95-30.18,98.08-22,122.75,32.39,21.8,48.06-15.92,104-58,110.11-36.18,5.24-79.27-7.55-93-50a99.36,99.36,0,0,1-4.77-29c-.48-41.33-.15-82.67-.08-124,0-9.78.6-10.3,10.45-10.29q6.25,0,12.53.1A12.17,12.17,0,0,1,229.72,27Zm-.46,133c-1.28,27.61,21,55.54,54.18,55.94a55.91,55.91,0,0,0,56.37-55.83c0-31.71-25.38-56.65-55.59-56.57C252.39,103.62,229.35,127.57,229.26,160Z"
        transform="translate(-204.33 -26.18)"
      />
    </svg>
  );
};
